                  ...
                  <div className='flex flex-col items-center w-full'>
                    <Link
                      ...
                      className={`flex items-center gap-3 py-2 px-3 rounded-lg w-full transition-colors
                        ...
                        ${!isActive ? 'text-gray-400 bg-gray-50 hover:bg-gray-100' : ''}
                      `}
                    >
                      <span className='flex items-center justify-center w-7 h-7'>
                        <span
                          className={`w-6 h-6 flex items-center justify-center rounded-full border
                              ${isActive ? 'border-green-500 bg-green-500 text-white' : 'border-gray-300 text-gray-400'}
                            `}
                        >
                    ...
                    {!isLast && <div className='w-px h-4 bg-gray-300 mt-2'></div>}
                  </div>
                </li>
              );
            })}
