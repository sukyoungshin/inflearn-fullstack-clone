...
export class LecturesService {
  ...
  async create(
    ...
    if (section.course.instructorId !== userId) {
      throw new UnauthorizedException('섹션을 생성할 권한이 없습니다.');
    }
  ...
  async update(
    ...
    if (lecture.course.instructorId !== userId) {
      throw new UnauthorizedException('강의를 수정할 권한이 없습니다.');
    }
  ...
  async findOne(lectureId: string, userId: string) {
    ...
    if (lecture.course.instructorId !== userId) {
      throw new UnauthorizedException('강의를 조회할 권한이 없습니다.');
    }
  ...
  async delete(lectureId: string, userId: string) {
    ...
    if (lecture.course.instructorId !== userId) {
      throw new UnauthorizedException('강의를 삭제할 권한이 없습니다.');
    }
